...
http.createServer(function(req, res){
	...
	if(req.method === 'POST'){
		...
		// semestri algus- ja lõpukuupäevad
...
function tluPhotoPage(res, htmlOutput, listOutput){
		...
		//res.write('<img src="https://greeny.cs.tlu.ee/~hansoskar/public_html/VP23/public/tluphotos/tlu_38.jpg" alt="TLÜst pilt">');
		//res.write('<img src="https://greeny.cs.tlu.ee/~rinde/media/photos/TLU_600x400/tlu_38.jpg" alt="TLÜst pilt">');
		res.write(pageFoot);
		return res.end();
}
